...
async function _temp() {
  // COMPILED BUILD: this build is never npm-installed, so the npm-deprecation
  // notice is inapplicable. Suppress whenever running under Bun (bundled or
  // via `bun dist/bundle.js`), not only when a compiled executable is detected.
  if (isInBundledMode() || isRunningWithBun() || isEnvTruthy(process.env.DISABLE_INSTALLATION_CHECKS)) {
    return null;
  }
